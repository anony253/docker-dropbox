...
RUN apt-key adv --keyserver pgp.mit.edu --recv-keys 1C61A2656FB57B7E4DE0F4C1FC918B335044912E > /dev/null
    # Note 'ca-certificates' dependency is required for 'dropbox start -i' to succeed
RUN apt-get -qqy install ca-certificates curl python-gpgme dropbox python3 \
